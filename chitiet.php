					...
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									Xin chào bạn, chào mừng bạn đã đến với trang của TPL.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									TPL sẽ mang đến cho bạn những tin tức nhanh chóng, thú vị.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									TPL sẽ khiến bạn sẽ quay lại với chúng tôi một lần nữa.
									<br>Cảm ơn bạn!
								</p>
							</div>
						</div>
